...
最新產品化方向請看：[台股做多當沖追蹤器 v1.2 路線圖](docs/ROADMAP_V1_2.md)。部署後照著 [部署後驗收清單](docs/DEPLOYMENT_ACCEPTANCE.md) 檢查公開站。這份路線圖固定三個原則：不為了增加推薦而放寬模型、資料不可信時不產生即時買多、所有訊號都要能盤後驗證。
